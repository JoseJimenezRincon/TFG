...
$(ObjDir)/aStartStatic_test.cpp_pre.cpp.tb.o : aStartStatic_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling aStartStatic_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/aStarStatic.cpp_pre.cpp.tb.o : aStarStatic.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling aStarStatic.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
